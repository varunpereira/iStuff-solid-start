...
export var search_icon = ({style = () => ""}) => (
	<svg stroke="currentColor" viewBox="0 0 24 24" stroke-width=".1" class={style()}>
...
export var mic_icon = ({style = () => ""}) => (
	<svg viewBox="0 0 1920 1920" class={style()}>
		<path
